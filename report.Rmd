...
For our final project we are looking at the student performance data set from the UCI Machine Learning Repository that measures the final student grade in a Portuguese class based on a variety of predictors. These predictors include but are not limited to:
...
## Summary of the data
Before we begin our analysis, we wish to explore the distribution of the data and confirm it follows a normal distribution.
